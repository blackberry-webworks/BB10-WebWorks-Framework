...
webview =
    ...
    create: function (ready) {
        ...
        //@else
        _webviewObj = window.qnx.webplatform.createWebView({processType: OUT_OF_PROCESS, defaultSendEventHandlers: ['onChooseFile'], defaultWebEventHandlers: ['InvokeRequestEvent']}, function () {
        //@endif
