...
webview =
    ...
    create: function (ready) {
        ...
        //@endif
            ...
            // Enable the eventHandlers checking for this webview, handles trapped events
            eventHandlers.init(webview);
            _webviewObj.onGeolocationPermissionRequest = eventHandlers.onGeolocationPermissionRequest;
            _webviewObj.onNetworkError = eventHandlers.onNetworkError;
...
webview.__defineGetter__('currentLocation', function () {
    return _webviewObj.url;
});
