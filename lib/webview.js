...
var networkResourceRequested = require('./webkitHandlers/networkResourceRequested'),
    ...
    geolocationPermissionRequest = require('./webkitHandlers/geolocationPermissionRequest'),
...
webview =
    ...
    create: function (ready) {
        ...
        //@endif
            ...
            var requestObj =  networkResourceRequested.createHandler(_webviewObj),
                permissionObj = geolocationPermissionRequest.createHandler(_webviewObj);
            ...
            // coming from native
            _webviewObj.onGeolocationPermissionRequest = permissionObj.onGeolocationPermissionRequest;
    ...
    notifyOpen: function (sid, code, value) {
        _webviewObj.notifyOpen(sid, code, value);
    },

    notifyHeaderReceived: function (sid, header, value) {
        _webviewObj.notifyHeaderReceived(sid, header, value);
    },

    notifyDataReceived: function (sid, responseText, length) {
        _webviewObj.notifyDataReceived(sid, responseText, length);
    },
