...
function onDialogRequested(eventArgs, baton) {
    ...
    //If this is a subresource event then let's just swallow it
    if (parsedArgs.dialogType === INSECURE_CONTENT_TYPE) {
        batonHandle.pass('{"setPreventDefault": true, "setResult": "true"}');
    } else {
        show(eventArgs);
    }
}
