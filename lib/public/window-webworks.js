...
(function () {
    ...
    // If the dom is done then let's fire the webworks ready and create the webworks object
    if (document.readyState === 'complete' || document.readyState === 'interactive') {
        createWebworksReady();
    } else {
        // If not, then lets get notified when it is done, this includes state changes
