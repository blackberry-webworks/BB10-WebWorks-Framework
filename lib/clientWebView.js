...
clientWebView =
    ...
    create: function (ready) {
        //@if qnxcar
        _clientWebViewObj = window.qnx.webplatform.createWebView({}, function () {
        //@else
        ...
        //@endif
            ...
            // Enable the permissions checking for this clientWebView, traps any native permission events
            // coming from native
            permissions.init(clientWebView);
            _clientWebViewObj.onGeolocationPermissionRequest = permissions.onGeolocationPermissionRequest;
            ...
            window.qnx.webplatform.getController().dispatchEvent("clientWebView.initialized", [_clientWebViewObj]);
    ...
    getSensitivity: function () {
        return _clientWebViewObj.getSensitivity();
    },

    setSensitivity: function (sensitivity) {
        return _clientWebViewObj.setSensitivity(sensitivity);
    },

    getBackgroundColor: function () {
        return _clientWebViewObj.getBackgroundColor();
    },

    setBackgroundColor: function (backgroundColor) {
        return _clientWebViewObj.setBackgroundColor(backgroundColor);
    }
