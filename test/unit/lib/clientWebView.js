describe("clientWebView", function () {
    ...
    describe("geometry", function () {
        ...
        it("can get geometry", function () {
            clientWebView.create();
            clientWebView.setGeometry(0, 0, 100, 100);
            expect(clientWebView.getGeometry()).toEqual({x: 0, y: 0, w: 100, h: 100});
        });
    });
