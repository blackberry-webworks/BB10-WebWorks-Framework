...
//	void createPropertySuccessCB( ids_request_id_t requestId, void* cb_data );
//	void setPropertySuccessCB( ids_request_id_t requestId, void* cb_data );
//	void deletePropertySuccessCB( ids_request_id_t requestId, void* cb_data );
...
public:
	...
	std::string GetProperties(const std::string& provider, int propertyType, int numProps, const char* properties);
//	std::string CreateProperty(const std::string& provider, int propertyType, const char *propertyName, const char* propertyValue);
//	std::string SetProperty(const std::string& provider, int propertyType, const char *propertyName, const char* propertyValue);
//	std::string DeleteProperty(const std::string& provider, int propertyType, const char *propertyName);
//	std::string DeleteLocalProperty(const std::string& provider, int propertyType, const char *propertyName);
