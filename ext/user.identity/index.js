...
module.exports = {
	...
	createProperty: function (success, fail, args, env) {
		success(ids.idsCreateProperty(args));
	},
	setProperty: function (success, fail, args, env) {
		success(ids.idsSetProperty(args));
	},
	deleteProperty: function (success, fail, args, env) {
		success(ids.idsDeleteProperty(args));
	},
	deleteLocalProperty: function (success, fail, args, env) {
		success(ids.idsDeleteLocalProperty(args));
	}
